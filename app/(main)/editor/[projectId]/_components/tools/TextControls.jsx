        ...
        <div className='space-y-6'>
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-xs mb-4 text-white/70">Click to add editable text to your canvas</p>
                </div>
                <Button onClick={addText} variant={"primary"} className={"w-full"}>
            ...
            {selectedText && (
                <div className="border-t pt-6 border-white/10">
                    ...
                    <div className="space-y-2 mb-4">
                        <label htmlFor="font family" className="text-xs text-white/70">Font Family</label>
                        <select
                            value={fontFamily}
                            onChange={(e) => applyFontFamily(e.target.value)}
                            className='w-full px-3 py-2 my-2 bg-slate-700 border-white/20 text-white text-sm'
                        >
                            {
                    ...
                    <div className="space-y-2 mb-4">
                        <label htmlFor="text picker" className="text-xs text-white/70">Text Color</label>
                        <div className="flex gap-2">
                            ...
                            <input
                                ...
                                className='h-10 w-10 rounded border border-white/20 bg-transparent cursor-pointer'
                            />
