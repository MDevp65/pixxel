...
import AIExtend from './tools/AIExtend';
import AIEditControls from './tools/AIEditControls';
...
function renderToolConfig(activeTool, project) {
  switch (activeTool) {
    ...
    case "ai_extender":
      return <AIExtend project={project} />

    case "ai_edit":
      return <AIEditControls project={project} />
