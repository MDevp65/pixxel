...
const EditorTopBar = ({ project }) => {
  ...
  const handleManualSave = async () => {
    try {
      ...
      toast.error("Error while saving project: ", error)
    }
  }
      ...
      <div className='border-b px-6 py-3'>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button variant={"ghost"} size={"sm"} className={`text-white ${!canUndo ? "opacity-50 cursor-not-allowed" : "hover:bg-slate-700"}}`}
      ...
      <UpgradeModal
        ...
        reason={
          restrictedTool === "export" ?
            "Free plan is limited to 20 exports per month. Upgrade to pro for unlimited exports." : undefined
        }
      />
    </>
  )
