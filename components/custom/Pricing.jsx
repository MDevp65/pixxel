...
import { PricingTable, useAuth, SignInButton } from '@clerk/nextjs'
...
const PricingCard = ({
    ...
    const { has, userId, isSignedIn } = useAuth()
...
const Pricing = () => {
    ...
    const plans = [
        ...
        },
        {
            ...
            featured: true,
            planId: "cplan_30Ln1McifjirIqLHK1uEVlxV9Bw",
            ...
            <div className='max-w-6xl px-6 mx-auto'>
                <div className='text-center mb-16'>
                    <h2 className="text-5xl font-bold text-white mb-6">
                        Simple {" "}
                        <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent pb-6">
                            Pricing
                        </span>
                    </h2>
